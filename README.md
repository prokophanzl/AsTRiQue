...
If you'd like to see AsTRiQue in action using a virtual agent, you can run the `virtual_agent.ipynb` notebook locally or check out the [showcase notebook online](https://colab.research.google.com/github/prokophanzl/AsTRiQue/blob/main/colab-showcase/virtual_agent_showcase.ipynb).
